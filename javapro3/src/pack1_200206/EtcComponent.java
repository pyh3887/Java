...
//Choice
       ...
       pn1.add(new Label("choice color",Label.RIGHT));
...
//Checkbox
       ...
       chk1=new Checkbox("kor",true);  chk2=new Checkbox("jpn",false);
...
public void itemStateChanged(ItemEvent e){
       ...
       else if(e.getItem().equals("yel")) c=Color.yellow;
